    ...
    def __init__(self):
        ...
        def get_square_root():
            ...
            if len(string_list) <= 1:
                text_to_display_below_done("NOT VALID LINK")
            else:
                ...
                text_to_display_below_done(display_text)
        ...
        self.bt3 = Button(self.root,text="Reset",command=lambda:[self.reset(), clear_text(), text_to_display_below_done(EMPTY_STRING)],font=("Times 12 bold"),bg=("orange"))
        ...
        entry1.place(x=45,y=100)
        self.bt1.place(x=50,y=PERM_Y_VALUE)
        self.bt2.place(x=100,y=PERM_Y_VALUE)
        self.bt3.place(x=150,y=PERM_Y_VALUE)
        self.bt4.place(x=200,y=PERM_Y_VALUE)
