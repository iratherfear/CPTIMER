WORKING_DIR = "/home/iratherfear/Desktop/GIT/"
from tkinter import *
import sys
import time
import os
...
def createFile(SHEET_NAME):
    ...
    HEADER_FILE = "RATING,TIME,PROBLEM_LINK"
    ...
    def __init__(self):
        ...
        def get_square_root():
            ...
            if len(string_list) <= 1:
                ...
                textToWrite = CURRENT_RATING + "," + self.t.get() + "," + str(x1) + '\n'
        ...
        def show():
            ...
            CURRENT_RATING = str(clicked.get())
